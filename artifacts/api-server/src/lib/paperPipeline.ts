...
// current iteration is the 7-dimension shape; v0.9.0 rebalanced the weights to
// 15/12/12/15/14/7/25, elevating Information-Theoretic Rigor to 25% so the rubric
// weights the system's information-flow rigor as a first-class axis. The exact
// dimensions and weights are still expected to move as we collect feedback.
//
// Convention while pre-1.0: bump MINOR (0.x.0) for dimension or weight changes,
// PATCH (0.x.y) for guidepost wording/calibration only. Promote to 1.0.0 once the
