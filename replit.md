...
- `scripts/src/paper.ts` is **pinned to the published v0.8.0 Zenodo snapshot** (DOI 10.5281/zenodo.20567720) — its `WEIGHTS` and `REQUIRED_RUBRIC_VERSION` deliberately stay at 0.8.0 (18/14/14/18/18/8/10) and do NOT follow the live `RUBRIC_VERSION`. A future paper at a newer rubric needs its own re-scored corpus + updated constants.
